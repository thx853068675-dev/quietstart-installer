...
import subprocess
import tempfile
from prepare import HAP_SHA, HAP_VERSION, HERE, UPSTREAM
...
name = f'quietstart-{HAP_VERSION}-{args.platform}-bundle'
with tempfile.TemporaryDirectory(prefix='quietstart-bundle-') as temporary:
    ...
    shutil.copyfile(args.hap, root/f'quietstart-{HAP_VERSION}.hap')
    ...
    (root/'SHA256SUMS.txt').write_text(f'{HAP_SHA}  quietstart-{HAP_VERSION}.hap\n', encoding='utf-8')
