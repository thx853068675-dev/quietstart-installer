...
2. 准备轻启 0.9.55 原始发布 HAP，SHA-256：`6004cf8e931c6b39a135459d76bbcf0bb1f7c13423fdb2d95234817b225a606e`。
...
- 设置 `QUIETSTART_TEST_HAP` 为真实 0.9.55 HAP 路径，会额外检查华为 ZIP 对齐填充及内嵌模块。
